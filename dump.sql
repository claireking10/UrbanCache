...
CREATE TABLE users (
  ...
  avatar_url  VARCHAR(500) DEFAULT '/images/default.png'
);
...
INSERT INTO users (username, email) VALUES ('explorer1', 'test@example.com');
INSERT INTO scores (user_id, score) VALUES (1, 5100);
...
-- Dump completed on 2026-03-19 17:43:12
